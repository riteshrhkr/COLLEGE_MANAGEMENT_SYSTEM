...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        ...
        heading.setForeground(new Color(178, 34, 34));
        ...
        String semester[] = { "First Year", "Second Year", "Third Year", "1st Semester", "2nd Semester", "3rd Semester",
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            try {
                ...
                String query2 = "insert into marks_Details values('" + crollno.getSelectedItem() + "', '"
